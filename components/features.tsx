    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          {/* Section header */}
          <div id="services-section" className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Driving quality and efficiency with cutting-edge technologies.</h2>
            <p className="text-xl text-gray-400">Leverage our industry-leading tools, expertise, and wealth of experience.</p>
          </div>

          {/* Items */}
          <div id="learnmore-section" className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Staffing Solutions</h4>
              <p className="text-lg text-gray-400 text-center">Providing Subject Matter Experts consulting services innovating scalable and secure solutions on wide range of enterprise and web applications.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-gray-400 text-center">We provide assistance in performing Functional Testing, Performance Testing, Test Automation, ETL Testing and Security Testing.</p>
            </div>
